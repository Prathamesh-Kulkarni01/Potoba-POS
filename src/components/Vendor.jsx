...
const GiftWebsite = ({name}) => {
  ...
  const featuredProducts = [
    ...
    },
    {
      ...
      price: "Rs. 500",
      image: "https://nurulgifts.com/cdn/shop/files/4comboBLUECOLOUR.jpg?v=1714501949&width=1445",
      category: "men"
    },
    {
      name: "Custom Storybook",
      price: "Rs. 490",
      image: "https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcQ4Ut7gNHAoCJTLgoaqEsWl1pYnHHL0KLwM1Zr8gehhQ5U328aa2bwjH4BazB51-0KP6HpubsXFMA8XmwNeNByOW5_isp8vziWPz7Nf2s6Y_njm-5BrrSTc",
      category: "children"
    },
    {
      name: "Couple's Memory Box",
      price: "$99.99",
      image: "https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcS-RQjdw_vK1ASB1Cr4YZlSdb5kM5BVkzrE94SQCUMIVJVy2pebQnpjlYhEaRnQeBKIYQ2kxXtFkZEHcqJ_NARbM15YWTJtcqkDs3ONryqOMVFebA5dRCjT",
      category: "all"
    }
  ];
    ...
    <div className="bg-gradient-to-br from-[#F7F1E5] to-[#EDE6D6] min-h-screen">
      ...
      <header className="bg-white shadow-md py-4 px-6 flex justify-between items-center">
        <div className="flex items-center">
          ...
          <h1 className="text-2xl font-bold text-rose-900">{name?.toUpperCase()}</h1>
        </div>
        ...
        <div className="grid  md:grid-cols-3 gap-6">
          {giftCategories.map((category, index) => (
            ...
            >
              ...
              <h4 className="text-xl font-bold mt-4 text-rose-800">{category.title}</h4>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {occasionTypes.map((occasion, index) => (
            ...
            >
              ...
              <h4 className="text-xl font-bold mt-4 text-rose-800">{occasion.title}</h4>
          ...
          {featuredProducts
            ...
            .map((product, index) => (
              ...
              >
                ...
                />
                <h4 className="text-xl font-bold text-rose-800">{product.name}</h4>
      ...
      <section className="container mx-auto py-16 px-4 bg-rose-50">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            <h3 className="text-3xl font-bold text-rose-900 mb-6">
              Our Story
            </h3>
            <p className="text-rose-700 mb-4">
              {name} was born from a simple belief: every gift should tell a story. We collaborate with artisans and designers to create personalized gifts that capture memories, celebrate relationships, and bring joy.
            </p>
            <p className="text-rose-700">
              Our mission is to make gifting an experience of love, thoughtfulness, and personal connection.
            </p>
      ...
      <footer className="bg-rose-900 text-white py-12">
        <div className="container mx-auto px-4 grid md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-rose-200">Personalized Gifts, Endless Emotions</p>
          </div>
          <div>
            <h5 className="font-bold mb-4">Quick Links</h5>
            <ul className="space-y-2">
              <li><a href="#" className="text-rose-300 hover:text-white">Home</a></li>
              <li><a href="#categories" className="text-rose-300 hover:text-white">Categories</a></li>
              <li><a href="#occasions" className="text-rose-300 hover:text-white">Occasions</a></li>
            </ul>
          </div>
          <div>
            <h5 className="font-bold mb-4">Customer Support</h5>
            <ul className="space-y-2">
              <li><a href="#" className="text-rose-300 hover:text-white">FAQs</a></li>
              <li><a href="#" className="text-rose-300 hover:text-white">Shipping</a></li>
              <li><a href="#" className="text-rose-300 hover:text-white">Returns</a></li>
            </ul>
          </div>
          <div>
            <h5 className="font-bold mb-4">Connect</h5>
            <div className="flex space-x-4">
              <a href="#" className="text-rose-300 hover:text-white">Facebook</a>
              <a href="#" className="text-rose-300 hover:text-white">Instagram</a>
            </div>
          </div>
        </div>
      </footer>
